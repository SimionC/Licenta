...
namespace App.Server.Migrations
{
    ...
    [Migration("20260623130608_AddCourseUserActivities")]
    partial class AddCourseUserActivities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Server.ORM.CourseUserActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("App.Server.ORM.NoteSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("SourceNoteGuid")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("App.Server.ORM.NotePermission", b =>
                {
                    b.HasOne("App.Server.ORM.User", "InvitedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Server.ORM.NoteSnapshot", b =>
                {
                    b.HasOne("App.Server.ORM.User", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("App.Server.ORM.Note", "SourceNote")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Server.ORM.SubmittedWork", b =>
                {
                    ...
                    b.HasOne("App.Server.ORM.NoteSnapshot", "NoteSnapshot")
                        .WithMany()
